...
public class ExportacaoTXT extends Exportacao{

    ExportacaoTXT(String nomeCSV, String nomeNovoArquivo) {
    ...
    protected void exportarComo(ArrayList<String[]> dados) {
        try {
            ...
            FileWriter fileWriter = new FileWriter(nomeNovoArquivo + ".txt");
            String head = "";
